...
<mark style="color:purple;">Premium Residential</mark> 是采用更严格设备筛选标准的代理池。池规模约为 Standard 的 10–15 倍：从 380 万到 460 万个 IP 地址。提供更广泛的地理定位，直至运营商级别。
...
| [UDP 支持](../about-udp/) | ✓（[部分城市及 macOS/iOS 设备除外](../restrictions.md)） |
